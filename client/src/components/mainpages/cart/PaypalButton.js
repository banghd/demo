...
export default class PaypalButton extends React.Component {
    render() {
        ...
        const client = {
            sandbox:    'sb-0o47vj4891381@business.example.com',//your sandbox app id
            production: 'AX5so4So5sxqHRGHAiAMo9fyUNh37aEbGYyisszcVV5-5csOjjoqOJMP5qA3r2Zxd5WWIht9LWk3kNn1',
        }
